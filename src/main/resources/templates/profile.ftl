                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <#elseIf completedDeal.statusDeal == "TRANSFERMONEY">
                                    ...
                                    <button type="button" class="boxed-btn3">Подтвердить получение</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <#if completedDeal.statusDeal == "CONFIRMLENDER">
                                    <button type="button" class="boxed-btn3">Подтвердить заключение сделки.
                                    </button>
                                <#elseIf completedDeal.statusDeal == "CONFIRMBORROWER">
                                    <button type="button" class="boxed-btn3">Перечислить денежные средства.
                                    </button>
                                <#elseIf completedDeal.statusDeal == "TRANSFERMONEY">
